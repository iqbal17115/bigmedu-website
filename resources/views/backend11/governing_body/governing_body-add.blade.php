...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ !empty($editData)? 'Update Governing Body Member' : 'Add Governing Body Member' }}</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Governing Body Member</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('governing_body.list')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View Governing Body Member</a>
            </div>
            <div class="card-body">
                <form action="{{ !empty($editData)? route('governing_body.update',$editData->id) : route('governing_body.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <select id="governing_member_id" @if(!empty($editData)) disabled @endif class="form-control form-control-sm select2" name="member_id">
                        ...
                        <div class="form-group col-sm-8">
                            <label>Designation in Governing Body</label>
                        ...
                        <button class="btn bg-gradient-success btn-flat"><i class="fas fa-save"></i> {{ !empty($editData)? 'Update Governing Body Member' : 'Save Governing Body Member' }}</button>
                </form>
