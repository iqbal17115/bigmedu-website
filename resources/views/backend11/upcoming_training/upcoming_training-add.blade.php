...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ !empty($editData)? 'Update Upcoming Training' : 'Add Upcoming Training' }}</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('frontend-menu.upcoming_training')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View Upcoming Training</a>
            </div>
            <div class="card-body">
                <form action="{{ !empty($editData)? route('frontend-menu.upcoming_training.update',$editData->id) : route('frontend-menu.upcoming_training.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
