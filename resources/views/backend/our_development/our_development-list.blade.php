...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Our Development</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">Our Development</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
        ...
        <div class="card-header">
          <div class="row">
            <div class="col-md-3 col-lg-3 col-xl-3">
              <a href="{{ route('site-setting.our_development.add') }}" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> Add Our Development</a>
            </div>
            <div class="col-md-9 col-lg-9 col-xl-9">
              <form action="{{ route('site-setting.our_development.background.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="row">
                  @php
                  ...
                  <div class="col-md-1 col-lg-1 col-xl-1" style="margin-left: 20px;margin-top: 8px;color: red;">
                    <input type="checkbox" name="show_section" class="form-check-input" id="show_section" value="1" {{ @$developmentBackground->show_section == 1 ? 'checked':'' }}>
                  ...
                  <div class="col-md-5 col-lg-5 col-xl-5 row">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6" style="padding: 0;">
                      <img src="{{asset('public/upload/our_development/'.@$developmentBackground->image) }}" height="40">
                    </div>
                  </div>
                  ...
                  <div class="col-md-1 col-lg-1 col-xl-1" style="margin-left: 20px;margin-top: 5px;">
                    <input type="checkbox" name="show_status" class="form-check-input" id="show_status" value="1" {{ @$developmentBackground->show_status == 1 ? 'checked':'' }}>
          ...
          <table id="dataTable" class="table table-sm table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>		                  	                 
                ...
                <td>{{ $ourDevelopment['title'] }}</td>
                <td><img src="{{ asset('public/upload/our_development/'.$ourDevelopment['image']) }}" height="80"></td>
                <td>{{ $ourDevelopment['sort_order'] }}</td>
                <td><a href="{{ route('site-setting.our_development.edit',$ourDevelopment->id) }}" class="btn btn-primary btn-flat btn-sm edit" data-type="image" data-id="" data-table="Slider"><i class="fas fa-edit"></i></a> | <a  class="delete btn btn-danger btn-flat btn-sm" data-route = "{{ route('site-setting.our_development.delete') }}" data-id="{{ $ourDevelopment->id }}" ><i class="fas fa-trash"></i></a> 
                </td>
              </tr>
              @endforeach                
            </tbody>                
