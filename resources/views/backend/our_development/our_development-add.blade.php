...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ !empty($editData)? 'Update Our Development' : 'Add Our Development' }}</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('site-setting.our_development')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View Our Development</a>
            </div>
            <div class="card-body">
                <form action="{{ !empty($editData)? route('site-setting.our_development.update',$editData->id) : route('site-setting.our_development.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <button class="btn bg-gradient-success btn-flat"><i class="fas fa-save"></i> {{ !empty($editData)? 'Update Our Development' : 'Save Our Development' }}</button>
                </form>
