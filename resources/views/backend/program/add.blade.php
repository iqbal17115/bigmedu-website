...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ !empty($editData)? route('site-setting.program.update',$editData->id) : route('site-setting.program.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
