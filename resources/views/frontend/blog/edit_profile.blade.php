        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <a href="{{ route('blog_user.home') }}" class="btn btn-sm pull-left" style="background: #afb3b0;">Create Post</a>
                    <a href="{{ route('blog_user.all_blog_post') }}" class="btn btn-sm btn-info pull-left" style="background: #afb3b0;">All Post</a>
                    <a href="{{ route('blog_user.edit_profile',auth('blog_user')->id()) }}" class="btn btn-sm btn-info pull-left" style="background: #9adb44;">Edit Profile</a>
                    ...
                    <div id="basic_info" class="tabcontent">
                        @if(!empty($editData))
                        <h4 style="margin-top: 3%;">Profile</h4>
                        @else
                        <h4 style="margin-top: 3%;">Profile</h4>
                        @endif
                        {{-- <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <form action="{{ !empty($editData)? route('blog_user.update_profile',$editData->id) : route('blog_user.update_profile') }}" method="post" enctype="multipart/form-data" autocomplete="off" id="myForm">
                            @csrf
                            <div class="form-row">
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <label style="font-size: 20px;">Name</label>
                                        <input id="name" name="name" type="text" value="{{@$editData->name}}" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label style="font-size: 20px;">Email</label>
                                        <input id="email" name="email" type="text" value="{{@$editData->email}}" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <label style="font-size: 20px;">Password</label>
                                        <input id="password" name="password" type="text" value="" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label style="font-size: 20px;">Confirm Password</label>
                                        <input id="password_confirmation" name="password_confirmation" type="text" value="" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-3" style="margin-top: 4px;">
                                        @if(@$editData->image)
                                            <img src="{{asset('public/upload/profile_photo/'.@$editData->image)}}" height="100px" alt="Image">
                                        @else
                                ...
                                <div class="form-group col-sm-3">
                                    <button style="margin-top: 10px;background: #5fd6f3;" class="btn btn-success btn-flat"><i class="fas fa-save"></i> @if(!empty($editData)) @lang('Update') @else @lang('Save')@endif</button>
                                </div>
                            </div>
                        </form>
                    </div>
              ...
              $('#myForm').validate({
                ...
                messages: {
                    ...
                    password:{
                        ...
                        pwcheck:"Password must contain combination with uppercase, lowercase and digit",
