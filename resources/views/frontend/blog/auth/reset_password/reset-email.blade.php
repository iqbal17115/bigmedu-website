...
<html>
  <head>
    ...
    <title>BIGM | Reset Password</title>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">User Email</p>

      <form action="{{route('blog_user.check.email')}}" method="post">
        @csrf
      ...
      <!-- /.social-auth-links -->
      <p class="mb-1">
        <a href="{{route('blog_user.login')}}">Login Page</a>
      </p>      
    </div>
  </div>
</div>
