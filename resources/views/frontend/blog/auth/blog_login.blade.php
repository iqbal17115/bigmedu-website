...
<section id="teacher" style="@if(@$fmenu) padding-top: 0px; @else padding-top: 75px; @endif">
    <div class="container">
        <div class="card" style="width: 60%; margin-left: auto; margin-right: auto;">
            ...
            <p class="login-box-msg">Blog User Login</p>
            
            <form action="{{route('blog_user.login')}}" method="post">
                @csrf
                ...
                <div class="row">
                  <!-- /.col -->
                  <div class="col-12">
                    <button type="submit" class="btn btn-block" style="background: #002D68;color: white;margin-top: 5px;">Login</button>
                    <a href="{{ route('blog_user.register') }}" class="btn btn-block" style="background: #8AC63D;margin-top: 15px;">Register</a>
                  </div>
                  <!-- /.col -->
                </div>
              </form>
            ...
            <!-- /.social-auth-links -->
            <p class="mb-1 mt-1">
                <a href="{{ route('blog_user.reset.password') }}">I forgot my password</a>
            </p>      
            {{-- @php
            dd(url()->previous());
            @endphp --}}
